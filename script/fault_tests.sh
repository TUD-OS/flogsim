...
export COLL="{simple_tree_bcast,checked_correctedtree_bcast,phased_checked_correctedtree_bcast,fixed_correctedtree_bcast}"
export L="{1..2}"
export o="1"
export g="1"
export P="{15,31,63,127,255,511,1023,2047,4095,8191,16383,32767,65535}"
export P="{15,31,63}"
export k="{2,3}"
export F="{1,2}"
